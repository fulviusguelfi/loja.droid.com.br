...
//        die;
        ...
        $redirectURI = HTTPS_SERVER . 'index.php?route=extension/module/opencartml/opcall';
...
//            header('Location: ' . HTTPS_SERVER . 'admin/index.php?route=extension/module/opencartml/configure&token=' . $token);
        }
