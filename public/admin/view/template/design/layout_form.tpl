...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footertop, #module-footerbottom,#module-footerleft,#module-footerright,#module-headertop').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footertop, #module-footerbottom, #module-footerleft ,#module-footerright,#module-headertop').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>